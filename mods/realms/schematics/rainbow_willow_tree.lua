--rainbow willow tree schematic modified from ethereal willow tree

local _ = {name = "air", prob = 0}
local L = {name = "realms:rainbow_willow_leaves", prob = 255}
local T = {name = "realms:rainbow_willow_trunk", prob = 255}
local t = {name = "realms:rainbow_willow_trunk", prob = 127}

bd_odd_biomes.rainbow_willow_tree = {
