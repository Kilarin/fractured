...
minetest.register_node("default:stone_with_esem", {
	description = "Esem Ore",
	tiles = {"default_stone.png^default_mineral_esem.png"},
	is_ground_content = true,
	groups = {cracky=1},
	drop = "default:esem_crystal",
	sounds = default.node_sound_stone_defaults(),
})

minetest.register_node("default:esem", {
	description = "Esem Block",
	tiles = {"default_esem_block.png"},
	is_ground_content = true,
	groups = {cracky=1,level=2},
	sounds = default.node_sound_stone_defaults(),
})
minetest.register_alias("default:esem_block", "default:esem")
