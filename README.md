...
**Change Log**<p>
0.082 wildweapons altered to use new register_on_punchplayer, this new function makes controling where damage happens EASY!!!  enable_pvp = true now and wildweapons disables it in the east<p>
